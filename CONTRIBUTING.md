...
```bash
# 克隆仓库
git clone https://github.com/youlai/apkpub-cli.git
cd apkpub-cli
...
请通过 [Issues](https://github.com/youlai/apkpub-cli/issues) 提交缺陷或功能建议，并使用对应模板。涉及安全漏洞请参阅 [SECURITY.md](SECURITY.md)。
